...
public static class StatUtil
{
    ...
    public static MainStats StringToMainStats(this string str)
    {
        return str switch
        {
            nameof(MainStats.MaxHP) => MainStats.MaxHP,
            nameof(MainStats.HealthRegen) => MainStats.HealthRegen,
            nameof(MainStats.HealthAbsorb) => MainStats.HealthAbsorb,
            nameof(MainStats.Armor) => MainStats.Armor,
            nameof(MainStats.DodgeChance) => MainStats.DodgeChance,
            nameof(MainStats.Speed) => MainStats.Speed,
            nameof(MainStats.Damage) => MainStats.Damage,
            nameof(MainStats.Melee) => MainStats.Melee,
            nameof(MainStats.Ranged) => MainStats.Ranged,
            nameof(MainStats.Elemental) => MainStats.Elemental,
            nameof(MainStats.Engineering) => MainStats.Engineering,
            nameof(MainStats.Tactical) => MainStats.Tactical,
            nameof(MainStats.AttackSpeed) => MainStats.AttackSpeed,
            nameof(MainStats.CritChance) => MainStats.CritChance,
            nameof(MainStats.Range) =>  MainStats.Range,
            nameof(MainStats.Luck) => MainStats.Luck,
            nameof(MainStats.Harvest) => MainStats.Harvest,
            _ => MainStats.None
        };
    }
    ...
    public static SubStats StringToSubStats(this string str)
    {
        return str switch
        {
            nameof(SubStats.FoodHeal) => SubStats.FoodHeal,
            nameof(SubStats.XPGain)         => SubStats.XPGain,
            nameof(SubStats.ItemPrice)      => SubStats.ItemPrice,
            nameof(SubStats.PickUpRange)    => SubStats.PickUpRange,
            nameof(SubStats.ExplosiveDamage)=> SubStats.ExplosiveDamage,
            nameof(SubStats.ExplosiveSize)  => SubStats.ExplosiveSize,
            nameof(SubStats.Bounces)        => SubStats.Bounces,
            nameof(SubStats.Piercing)       => SubStats.Piercing,
            nameof(SubStats.PiercingDamage) => SubStats.PiercingDamage,
            nameof(SubStats.FreeRerolls)    => SubStats.FreeRerolls,
            nameof(SubStats.Enemies)        => SubStats.Enemies,
            nameof(SubStats.EnemiesSpeed)   => SubStats.EnemiesSpeed,
            nameof(SubStats.RerollPrice)    => SubStats.RerollPrice,
            nameof(SubStats.Knockback)      => SubStats.Knockback,
            nameof(SubStats.BurningSpeed) => SubStats.BurningSpeed,
            _ => SubStats.None,
        };
    }
